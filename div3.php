...
$divTextValue=$selSection2['div3Text'];
 ?>
<html>
<head>
  <meta charset="utf-8">
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Div 3</h3>
            </div>
            <!-- /.box-header -->
			<form id="frm1" enctype="multipart/form-data" method="post" action="insertDivSectionDetails.php" >
            <div class="box-body">
			<input type="hidden" id="page" name="page" value="div3" />
              <div class="form-group">
                  <label for="exampleInputFile">File input ( Div 3 Image )</label>
